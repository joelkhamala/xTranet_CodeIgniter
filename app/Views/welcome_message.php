                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <div class="tab-content">
                              <div class="tab-pane active" id="tab01" role="tabpanel">
                                   ...
                                   <div class="tab-pane-item">
                                    <a href="/more-features" class="btn btn-primary">Read more</a>
                                   </div>
                              </div>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="copyright-text col-md-12 col-sm-12">
                         <div class="col-md-6 col-sm-6">
                              <p>Copyright &copy; <?= date('Y')?> xtraNet Web Design:
                				<a rel="nofollow" href="http://xtranet.com">xTranet</a></p>
                         </div>
